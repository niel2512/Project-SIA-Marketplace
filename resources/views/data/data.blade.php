                        ...
                        @foreach ($hasil->data as $p)
                            <div class="col-md-4">
                                <div class="card mb-4 box-shadow">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">{{$p->dataset}}</p>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                                                <a class="btn btn-sm btn-outline-secondary" href="{{$p->file_url}}" role="button" target="_blank">View</a>
                                            </div>
                                            <small class="text-muted">{{$p->created}}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
